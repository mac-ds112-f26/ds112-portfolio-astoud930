...
``` 
#This labels our axis respectively
...
ggplot(hikes, aes(x = rating)) +
  ...
  labs(x = "Rating", y = "Number of hikes")
```
#orange boarder added and orange fill changed in the box
...
#the purpose of the + is to add details to the code
#### Part a

Reflect on the `ggplot()` code.

-   What's the purpose of the `+`? When do we use it? #strings code together
#
...
#color changes the borer fill changes the inside
#### Part b
...
#I think it's very unorganized

```{r}
# ```{r}
# rating turned into elevation
...
-   How many total hikes have an elevation of at least 5100 feet? #1.5
