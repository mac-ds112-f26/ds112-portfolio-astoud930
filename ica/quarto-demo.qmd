...
Rep(x = 1, times = 10) seq(from=100,to=1000,length=20)
...
How does this appear in the .qmd? The .html?

seq(from = 100, to = 1000, by = 50)

temperature_f <- temperature_c * 9/5 + 32

temperature_c <- 10 temperature_f <- temperature_c * 9/5 + 32 temperature_f
